...
namespace Superbar.Adapters
{
    ...
    public class IMessageContractToViewAddInAdapter : Superbar.Views.IMessage
    {
        ...
        public Superbar.Views.IMessageEntry MessageEntry
        {
            get
            {
                return Superbar.Adapters.IMessageEntryAddInAdapter.ContractToViewAdapter(_contract.MessageEntry);
            }
        }
