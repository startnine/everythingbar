...
namespace Superbar.Adapters
{
    ...
    {
        internal static Superbar.Views.MessageReceivedEventArgs ContractToViewAdapter(Start9.Api.Contracts.IMessageReceivedEventArgsContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IMessageReceivedEventArgsContract ViewToContractAdapter(Superbar.Views.MessageReceivedEventArgs view)
        {
            if ((view == null))
            {
                return null;
