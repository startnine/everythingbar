...
namespace Superbar.Adapters
{
    ...
    {
        internal static Superbar.Views.IConfiguration ContractToViewAdapter(Start9.Api.Contracts.IConfigurationContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IConfigurationContract ViewToContractAdapter(Superbar.Views.IConfiguration view)
        {
            if ((view == null))
            {
                return null;
