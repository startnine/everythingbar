...
namespace Superbar.Adapters
{
    ...
    {
        internal static Superbar.Views.IModule ContractToViewAdapter(Start9.Api.Contracts.IModuleContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleContract ViewToContractAdapter(Superbar.Views.IModule view)
        {
            if ((view == null))
            {
                return null;
