...
namespace Superbar.Adapters
{
    ...
    {
        internal static Superbar.Views.IModuleInstance ContractToViewAdapter(Start9.Api.Contracts.IModuleInstanceContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleInstanceContract ViewToContractAdapter(Superbar.Views.IModuleInstance view)
        {
            if ((view == null))
            {
                return null;
