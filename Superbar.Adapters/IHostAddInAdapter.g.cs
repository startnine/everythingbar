...
namespace Superbar.Adapters
{
    ...
    {
        internal static Superbar.Views.IHost ContractToViewAdapter(Start9.Api.Contracts.IHostContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IHostContract ViewToContractAdapter(Superbar.Views.IHost view)
        {
            if ((view == null))
            {
                return null;
