...
namespace Superbar.Adapters
{
    ...
    {
        internal static Superbar.Views.IMessage ContractToViewAdapter(Start9.Api.Contracts.IMessageContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IMessageContract ViewToContractAdapter(Superbar.Views.IMessage view)
        {
            if ((view == null))
            {
                return null;
