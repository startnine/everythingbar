...
namespace Superbar.Adapters
{
    ...
    {
        internal static Superbar.Views.IConfigurationEntry ContractToViewAdapter(Start9.Api.Contracts.IConfigurationEntryContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IConfigurationEntryContract ViewToContractAdapter(Superbar.Views.IConfigurationEntry view)
        {
            if ((view == null))
            {
                return null;
