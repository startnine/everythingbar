...
namespace Superbar.Adapters
{
    ...
    {
        internal static Superbar.Views.IReceiverContract ContractToViewAdapter(Start9.Api.Contracts.IReceiverContractContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IReceiverContractContract ViewToContractAdapter(Superbar.Views.IReceiverContract view)
        {
            if ((view == null))
            {
                return null;
