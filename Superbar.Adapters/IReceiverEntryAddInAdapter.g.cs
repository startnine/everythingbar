...
namespace Superbar.Adapters
{
    ...
    {
        internal static Superbar.Views.IReceiverEntry ContractToViewAdapter(Start9.Api.Contracts.IReceiverEntryContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IReceiverEntryContract ViewToContractAdapter(Superbar.Views.IReceiverEntry view)
        {
            if ((view == null))
            {
                return null;
